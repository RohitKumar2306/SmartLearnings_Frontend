...
/*  const showMeta =
  ...
  return (
    <div className="courses-toolbar">
       {/*Header row (title + meta pill)
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 mb-3 courses-toolbar-header">
        <div>
          <h2 className="courses-toolbar-title mb-1">{title}</h2>
          <p className="courses-toolbar-subtitle mb-0">{subtitle}</p>
        </div>

        {showMeta && (
          <span className="courses-toolbar-meta-pill">
            Showing <span className="fw-semibold">{visibleCount}</span> of{" "}
            <span className="fw-semibold">{totalCount}</span> courses
          </span>
        )}
      </div>*/}
      ...
      <div className="row g-2 align-items-center">
        ...
        <div className="col-6 col-md-5">
          <label className="courses-toolbar-label small mb-1">Search</label>
        ...
        <div className="col-6 col-md-3">
          <label className="courses-toolbar-label small mb-1">Status</label>
          <select
        ...
        <div className="col-6 col-md-4">
          <label className="courses-toolbar-label small mb-1">Sort by</label>
          <select
            className="form-select form-select-sm courses-toolbar-select"
            value={sortBy}
